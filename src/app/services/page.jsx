        ...
        <section className=''>
            ...
            <div className='flex gap-5 '>
                <div className="relative z-0  mt-20 mx-auto lg:w-[20%]">
                    <div className="absolute  top-7 left-0 w-72 h-72 bg-color_1 z-10 rounded-full" />
                    <img className="w-72 z-50 relative" src="/assets/photoDr.png" />
                </div>

                <div className='lg:w-[50%] py-14'>
                    <Accordion/>
                </div>
            </div>

            <div className='py-20 bg-color_4  lg:px-28'>
                <div className='text-center'>
                    <h3 className='text-4xl font-bold text-color_1'>Transformations That Speak Volumes</h3>
                    <p className='text-color_1 py-6 w-[70%] m-auto'>
